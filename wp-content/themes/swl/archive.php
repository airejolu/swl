						...
						<?php
							if ( is_category() ) {
								...
								*/
								...
								printf( __( 'Daily Archives: %s', 'swl' ), '<span>' . get_the_date() . '</span>' );

							} elseif ( is_month() ) {
								printf( __( 'Monthly Archives: %s', 'swl' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );

							} elseif ( is_year() ) {
								printf( __( 'Yearly Archives: %s', 'swl' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
